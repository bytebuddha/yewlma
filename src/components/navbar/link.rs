...
pub struct Link<SW: Switch + Clone + 'static = NullSwitchImplementor, STATE: RouterState = ()> {
    props: Props<SW>,
...
impl<SW: Switch + Clone + 'static, STATE: RouterState> Component for Link<SW, STATE> {
    type Message = Msg;
